...
import { EVENT_CREATE, EVENT_LISTING, EVENT_UPDATE ,EVENT_BOOKING ,EVENT_BOOKING_GET,EVENT_BOOKING_CANCEL ,EVENT_DELETE} from "../dist/api";
...
export const REQUEST_DELETE_EVENT = (id, callback) => {
    return PUT(EVENT_DELETE.replace(':id', id)).set(authHeader()).end(callback);
};
